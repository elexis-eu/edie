...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.about  # this is an instance of the class Endpoint
        api_instance.about()  # this invokes api_instance.about.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.about.callable or self.callable in this class
