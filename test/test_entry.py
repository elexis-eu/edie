"""
    ...
    This protocol allows data to be shared with the ELEXIS platform and should be implemented
    by all providers of data to the ELEXIS platform. This is an OpenAPI documentation,
    for more details about using this specification,
    please refer to OpenAPI documentations:
    https://swagger.io/resources/articles/documenting-apis-with-swagger/  # noqa: E501
...
class TestPublisherMetadata(unittest.TestCase):
    ...
    def test_result(self) -> None:
        ...
        self.assertIsNotNone(result[Vocabulary.PUBLISHER])
...
class TestLicence(unittest.TestCase):
    ...
    def test_result(self) -> None:
        ...
        self.assertIsNotNone(result[Vocabulary.LICENSE])
...
class TestSizeOfDictionary(unittest.TestCase):
    ...
    def test_result(self) -> None:
        ...
        self.assertIsNotNone(result[Vocabulary.SIZE_OF_DICTIONARY])
...
class TestRecency(unittest.TestCase):
    ...
    def test_result(self) -> None:
        ...
        evaluator.analyze(metadata_entry)
        result = evaluator.result()
        self.assertIsNotNone(result[Vocabulary.RECENCY])
...
class TestMetadataQuantity(unittest.TestCase):
    ...
    def test_result(self) -> None:
        ...
        result = evaluator.result()
        self.assertIsNotNone(result[Vocabulary.METADATA_NONEMPTY_FIELDS])
        self.assertIsNotNone(result[Vocabulary.METADATA_FIELDS])
